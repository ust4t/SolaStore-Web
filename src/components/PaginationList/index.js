  ...
  return (
    <div className="row gy-3">
      <ReactPaginate
        ...
        nextClassName=""
        previousLabel={
          <i className="fas fa-angle-double-left basic-pagination basic-pagination-2 me-2" />
        }
        nextLabel={
          <i className="fas fa-angle-double-right basic-pagination basic-pagination-2 me-2" />
        }
        breakLabel={"..."}
        pageCount={pageCount}
